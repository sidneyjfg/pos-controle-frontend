...
export const Navbar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/product-groups', label: 'Categorias', icon: 'M4 6a2 2 0 012-2h3l2 2h7a2 2 0 012 2v2H4V6z M4 12h16v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6z' },
    ...
    { path: '/invoices', label: 'Notas', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
